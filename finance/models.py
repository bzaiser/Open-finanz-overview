...
class Pension(models.Model):
    ...
    contribution_start_date = models.DateField(verbose_name=_("Contribution Start Date"), blank=True, null=True, help_text=_("Date when you started paying into this pension"))
