...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DecimalField(blank=True, decimal_places=2, help_text='Net payout after KV/PV deductions', max_digits=10, null=True, verbose_name='Expected Monthly Net Payout'),
        ),
    ]
