...
class Command(BaseCommand):
    help = "Seeds the database with a realistic demo family dataset"
    ...
    def handle(self, *args, **options):
        ...
        p_markus = Pension.objects.create(
            ...
            expected_payout_at_retirement=Decimal("2037.00"),
            retirement_age=67,
            start_payout_date=date(2043, 5, 15)
        )

        # Historische Stichtage Markus
        ...
        p_sandra = Pension.objects.create(
            ...
            retirement_age=67,
            start_payout_date=date(2045, 9, 1)
        )

        # C) Private Altersvorsorge / Betriebsrente Markus
        ...
        self.stdout.write(self.style.SUCCESS("✅ Demo-Familien-Datensatz erfolgreich angelegt!"))
        self.stdout.write(f"Benutzername: {username}")
        self.stdout.write(f"Passwort:    {password}")
