...
class PensionAdmin(BaseOwnedModelAdmin):
    list_display = ('provider', 'pension_type', 'user', 'pension_points', 'point_value', 'gross_payout_amount', 'social_deduction_rate', 'expected_payout_at_retirement', 'is_indexed', 'notes')
